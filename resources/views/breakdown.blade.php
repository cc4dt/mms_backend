...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{Auth::user()->level->value}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>{{ $show->number ?? '' }}</th>
                                <th>
                                    {{ $show->timeline->status->name }}
                                </th>
                                <th>{{ $show->state->name ?? '' }} </th>
                                <th>{{ $show->station->name ?? '' }}</th>
                                ...
                                <th>
                                    ...
                                    <a href="{{asset(route('breakdown.edit',$show->id))}}">
                                    ...
                                    <a href="{{asset(route('breakdown.show', $show->id))}}">
                                    ...
                                    {{" - "}}
                                    <a href="#">
                                        <li class="fa fa-trash" style="color: rgb(255,0,0);"
                                            data-id="{{ $show->id ?? '' }}" data-name="{{ $show->number ?? '' }}"
                                ...
                                <form method="POST" action="{{asset('change')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="Oldpassword2" type="hidden" name="Oldpassword2"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="ConfirmPassword" type="password" name="ConfirmPassword"
                                                ...
                                                data-vldtr="matches" data-vldtr-matches="NewPassword"
                                                class="form-control">
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="modal-save">
                    <div class="modal-dialog modal-lg">
                        <form method="POST" action="{{route('breakdown.store')}}">
                            @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="state_id" name="state_id"
                                                class="select2bs4 form-control @error('state_id') is-invalid @enderror"
                                                style="width: 100%; height: 30;" data-vldtr="required">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="station_id" name="station_id" value="{{ old('station_id') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="2"
                                                class="form-control @error('open_description') is-invalid @enderror"
                                                name="open_description" id="open_description" rows="5"></textarea>
                        ...
                        <div class="modal-content bg-danger">
                            <div class="modal-header">
                                <h4 class="modal-title">Delete ticket
                                    ...
                                    <form method="POST" action="{{route('breakdown.destroy','delete')}}">
                                        {{method_field('delete')}}
                                        @csrf
                ...
                <div class="modal fade" id="modal-action">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content bg-default">
                            <div class="modal-header">
                                <h4 class="modal-title">Assign Ticket
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="number" class="form-control" value="" id="type">
                                ...
                                <div class="row">
                                    ...
                                    <select id="teamleader_id" name="teamleader_id"
                                        class="select2bs4 form-control @error('state_id') is-invalid @enderror"
                                        style="width: 100%; height: 30;" data-vldtr="required">
                                        @if(isset($showteamleader))
                                        @foreach($showteamleader as $data)
                            ...
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default btn-outline-light"
                                    data-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-success btn-outline-light">Assign</button>
                                </form>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                ...
                <div class="modal fade" id="modal-edit">
                    <div class="modal-dialog modal-lg">
                        <form method="POST" action="{{route('breakdown.update',$showupdate->id)}}">
                            @csrf
                            {{method_field('patch')}}
                            <input type="hidden" name="number" value="{{$showupdate->number}}">
                            <input type="hidden" name="id" value="{{$showupdate->id}}">
                            <input type="hidden" name="updated_by_id" value="{{ Auth::user()->id ?? '' }}">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="state_id" name="state_id"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$showupdate->state_id){ ?> selected="true"
                                                    <?php } ?>>{{$data->name_en ?? ''}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="station_id" name="station_id" value="{{ old('station_id') }}"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$showupdate->station_id){ ?> selected="true"
                                                    <?php } ?>>
                                                    {{$data->name_en ?? ''}}
                                                </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="equipment_id" name="equipment_id"
                                                ...
                                                @foreach($equipmentdata as $data)
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$showupdate->equipment_id){ ?> selected="true"
                                                    <?php } ?>>{{$data->name_en ?? ''}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="breakdown_id" name="breakdown_id"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$showupdate->breakdown_id){ ?> selected="true"
                                                    <?php } ?>>
                                                    {{$data->name_en ?? ''}}
                                                </option>
                                                @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="5"
                                                class="form-control @error('open_description') is-invalid @enderror"
                                                name="open_description" id="open_description" rows="5">
{{$showupdate->open_description}}
</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <!-- ============================================== -->
                                        <div class="col-md-12">
                                            <label>{{ __('Works Descriptions') }}</label>
                                            <textarea rows="2"
                                                class="form-control @error('work_description') is-invalid @enderror"
                                                name="work_description" id="work_description" rows="5">
  {{$showupdate->work_description}}
  </textarea>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="modal-body">
                            ...
                            <table width="100%" border="0" align="center">
                                <tr>
                                    <td align="left" width="70" valign="middle"><img
                                            src="{{ url('storage/logo/'.$data->Att) }}" alt="" title="" width="60"
                                            height="60" /></th>
                                    <td width="60">
                                        </th>
                                    <td align="center">
                                        <font face="arial" size="+2" color="#040168"> Service Ticket </font>
                                        </th>
                                    <td align="right" width="165" valign="middle"><img
                                            src="{{ url('storage/logo/HAM.jpg') }}" alt="" title="" width="130"
                                            height="30" /></th>
                                </tr>
                            </table>
                            ...
                            <table border="1" align="center" width="100%" style="border-collapse: collapse;">
                                <tr>
                                        ...
                                        <table width="100%" border="0" align="center"
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    ...
                                                    <font face="arial" size="3" style="float: right;">
                                                        {{ $data->name ?? '' }}</font>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Field:</font>

                                                    <font face="arial" size="3" style="float: right;"> Block
                                                        {{ $data->blockName ?? '' }}</font>
                                                    </th>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Well:</font>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Rig:</font>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Run:</font>

                                                    <font face="arial" size="3" style="float: right;">
                                                        {{ $data->run ?? '' }}@if($data->run2!='N/A')#{{ $data->run2 ?? '' }}
                                                        @endif @if($data->run3){{ $data->run3 ?? '' }} @endif</font>
                                                    </th>
                                    ...
                                    <td width="50%">
                                        <table width="98%" border="0" align="center" style="border-collapse: collapse;">
                                            <tr>
                                                <td width="50%">

                                                    <font face="arial" size="3" style="float: left;">Ticket Number:
                                                    </font>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Arrive Locations:
                                                    </font>

                                                    <font face="arial" size="3" style="float: right;">
                                                        <?php echo date_format(date_create($data->arraive_location),'d-M-y'); ?>
                                                    </font>
                                                    </th>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Job Start:</font>

                                                    <font face="arial" size="3" style="float: right;">
                                                        <?php echo date_format(date_create($data->startdate),'d-M-y'); ?>
                                                    </font>
                                                    </th>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;">Job End:</font>

                                                    <font face="arial" size="3" style="float: right;">
                                                        <?php echo date_format(date_create($data->enddate),'d-M-y'); ?>
                                                    </font>
                                                    </th>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <font face="arial" size="3" style="float: left;"></font>

                                                    <font face="arial" size="3" style="float: right;">&nbsp;</font>
                                                    </th>
                            ...
                            <table width="100%" align="center" border="1" style="border-collapse: collapse;">
                                <tr>
                                    <td>
                                        <font face="arial" size="3" style="float: left;">Contract Number:</font>&nbsp;

                                        <font face="arial" size="3" style="float: left;">{{ $data->contractno ?? '' }}
                                        </font>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <font face="arial" size="3" style="float: left;">Contract Name:</font>&nbsp;

                                        <font face="arial" size="3" style="float: left;">
                                            <?php echo $data->contract_name; ?></font>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" align="center" border="1" style="border-collapse: collapse;">
                                <tr>
                                    <td>
                                        <font face="arial" size="3" style="float: left;">Service Instructions:&nbsp;

                                            <?php  echo $data->service_desc; ?></font>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" align="center" border="1" style="border-collapse: collapse;">
                                <thead>
                                    <tr style="background-color:rgba(22,54,92);">
                                        <th width="17%" height="30" align="center">
                                        ...
                                        <th width="38%" align="center">
                                            <font face="arial" face="arial" size="2" color="#ffffff">
                                        ...
                                        <th align="center" width="12%" align="center">
                                            <font face="arial" size="2" color="#ffffff">
                                                <center>Price $</center>
                                            </font>
                                        </th>
                                        <th align="center" width="9%" align="center">
                                            <font face="arial" size="2" color="#ffffff">
                                                <center>Discount</center>
                                            </font>
                                        </th>
                                        <th align="center" width="13%" align="center">
                                            <font face="arial" size="2" color="#ffffff">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <font face="arial" size="2" style="float: left;">&nbsp;{{$data2->UID}}
                                            </font>
                                            </th>
                                        <td>
                                            <font face="arial" size="2" style="float: left;">&nbsp;{{$data2->service}}
                                            </font>
                                            </th>
                                        <td align="center">
                                            <font face="arial" size="2">{{$data2->qty}}</font>
                                            </th>
                                        <td align="center">
                                            <font face="arial" size="2">{{$data2->uom}}</font>
                                            </th>
                                        <td>
                                        ...
                                        <td align="center">
                                            <font face="arial" size="2">{{$data2->discount}} %</font>
                                            </th>
                                        <td>
                                            <font style="float:left">$</font>
                                            <center>
...
?>
                                    ...
                                    @endif
                                    @endforeach
                                    <tr style="background-color:rgba(250,191,143);">
                                        <th colspan="6">
                                            <center>
                                                <font face="arial" size="2"> {{$data3->service_category }} Sub-Total
                                                    ({{$data2->Currency }})</font>
                                            </center>
                                        </th>
                                        ...
                                        <th>
                                            <font style="float:left">$</font>
                                            <center>
                                                <font face="arial" size="2"><?php echo number_format($sum3,2);?></font>
                                            </center>
                                        </th>
                                    </tr>
                                    ...
                                    <tr style="background-color:rgba(22,54,92);">
                                        <td colspan="6" align="center">
                                            <center>
                                                <font face="arial" size="2" color="#ffffff">Service Ticket Grand-Total
                                                    ({{ $data2->Currency ?? '' }})</font>&nbsp;
                                            </center>
                                            </th>
                                        <th>
                                            <font style="float:left" color="ffffff">$</font>
                                            <center>
                                                <font face="arial" size="2" color="#ffffff" style="">
                                                    <?php echo number_format($sum2,2); ?></font>
                                            </center>
                                        </th>
                                    </tr>
                                </tbody>
                            ...
                            <table width="100%" align="center" border="0" style="border-collapse: collapse;"
                                ...
                                <tr>
                                    <td>
                                        <p align="justify">
                                            <font face="arial" size="2"> THE ESTIMATED CHARGES SHOWN ABOVE MAY BE
                                                EXCLUSIVE OF TAX AND THE FINAL INVOICE WILL INCLUDE ALL APPLICABLE
                                                TAXES. </font>
                                        </p>
                                        <p align="justify">
                                            <font face="arial" size="2">
                                                THE SERVICES, EQUIPMENT, MATERIALS AND/OR PRODUCTS COVERED BY THIS
                                                SERVICE TICKET HAVE BEEN PERFORMED OR RECEIVED AS SET FORTH ABOVE.
                                            </font>
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" align="center" border="0" style="border-collapse: collapse;">
                                <tr align="center">
                                    ...
                                    <td align="center" width="33%">
                                        <font face="arial" size="3"> {{ $data->name ?? '' }} Representative </font>
                                        </th>
                                </tr>
                                <tr>
                                    <td align="center" width="33%">
                                        <font face="arial" size="3"><b> {{ $data->Supervisor ?? ''  }}</b></font>
                                        </th>
                                    <td align="center" width="33%">
                                        </th>
                                    <td width="33%" align="center">
                                        <font face="arial" size="3"><b> {{ $data->Representative ?? ''  }}</b></font>
                                        </th>
                                </tr>
...
-->
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary"
                                onclick="PrintDiv2();PrintDiv3();PrintDiv4();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="ticketno" readonly="true" data-vldtr="required" type="text"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="Clients" name="Clients"
                                            class="select2bs4 form-control @error('Clients') is-invalid @enderror"
                                            style="width: 100%; height: 30;" data-vldtr="required">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select id="block" name="block" value="{{ old('block') }}"
                                            class="select2bs4 form-control @error('block') is-invalid @enderror"
                                            data-vldtr="required">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select id="location" name="location"
                                            class="select2bs4 form-control @error('location') is-invalid @enderror"
                                            data-vldtr="required">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select id="well" name="well"
                                            class="select2bs4 form-control @error('well') is-invalid @enderror"
                                            data-vldtr="required">
                                    ...
                                    <tr>
                                        <td width="2%">
                                            <span id="showli<?php echo $shc->id; ?>" style="display: ;">
                                                <li class="fa fa-plus"
                                                    onclick="show('span<?php echo $shc->id; ?>','hideli<?php echo $shc->id; ?>','showli<?php echo $shc->id; ?>')">
                                                </li>
                                            </span>
                                            <span id="hideli<?php echo $shc->id; ?>" style="display: none;">
                                                <li class="fa fa-minus"
                                                    onclick="hide('span<?php echo $shc->id; ?>','hideli<?php echo $shc->id; ?>','showli<?php echo $shc->id; ?>')">
                                                </li>
                                            </span>
                                        ...
                                        <td>
                                            <a href="#"
                                                onclick="show('span<?php echo $shc->id; ?>','hideli<?php echo $shc->id; ?>','showli<?php echo $shc->id; ?>')">{{ $shc->service_category }}</a>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="{{$sho->id}}">
                                                ...
                                                <th>
                                                    <input type="checkbox" name="Actcat<?php echo $shc->id; ?>"
                                                        value="<?php echo $shc->id; ?>" />
                                                    <select id="rows[{{$sho->id}}][CAT]" name="rows[{{$sho->id}}][CAT]"
                                                        class="select2bs4 form-control @error('CAT') is-invalid @enderror"
                                                        data-vldtr="required" style="display: none;">
                                                    ...
                                                    <input name="rows[{{$sho->id}}][items]" type="hidden"
                                                        value="{{$sho->id}}" size="4">
                                                    <input name="rows[{{$sho->id}}][client]" type="hidden"
                                                        value="{{$sho->clientid}}" size="4">


                                                    <input id="Description{{$sho->id}}" data-vldtr="required"
                                                        type="hidden"
                                                        class="form-control @error('Description') is-invalid @enderror"
                                                        name="rows[{{$sho->id}}][Description]"
                                                        value="{{ $sho->service }}" readonly="true">
                                                    {{ $sho->service }}
                                                </th>
                                                <th><input id="Qty{{$sho->id}}" type="text"
                                                ...
                                                <th> <input id="UOM{{$sho->id}}" data-vldtr="required" type="text"
                                                        class="form-control @error('UOM') is-invalid @enderror"
                                                        name="rows[{{$sho->id}}][UOM]" value="{{ $sho->uom }}"
                                                        readonly="true" size="7"></th>
                                                <th> <input id="Price{{$sho->id}}" data-vldtr="required" type="text"
                                                        class="form-control @error('Price') is-invalid @enderror"
                                                        name="rows[{{$sho->id}}][Price]" value="{{ $sho->price }}"
                                                        readonly="true" size="7"></th>
                                                <th> <input data-vldtr="required" type="number"
                                                        class="form-control @error('Discount') is-invalid @enderror"
                                                        name="rows[{{$sho->id}}][Discount]" value="0"
                                                        autocomplete="Discount" size="2"></th>
                                            </tr>
        ...
        if (state) {
            jQuery.ajax({
                ...
                success: function(data) {
                    ...
                    $('select[name="station_id"]').append(
                        '<option value="">-Select Once-</option>');
                    jQuery.each(data, function(key, value) {
                        $('select[name="station_id"]').append('<option value="' +
                            key + '">' + value + '</option>');
                    });
                }
            });
        ...
        if (equipment) {
            jQuery.ajax({
                ...
                success: function(data) {
                    ...
                    $('select[name="breakdown_id"]').append(
                        '<option value="">-Select Once-</option>');
                    jQuery.each(data, function(key, value) {
                        $('select[name="breakdown_id"]').append('<option value="' +
                            key + '">' + value + '</option>');
                    });
                }
            });
