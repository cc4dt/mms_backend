...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Teamleader</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
<font size="2">
 ...
 <a href="{{asset(route('Teamleader.edit',$show->id))}}"> <li class="fa fa-edit" ></li>
       ...
       {{" - "}}
                            ...
                            <a href="{{asset(route('Teamleader.show',$show->id))}}"> <li class="fa fa-eye" data-backdrop="static"
...
<div class="modal fade" id="modal-save">
        <div class="modal-dialog modal-lg">
              <form method="POST" action="{{route('Teamleader.store')}}">
                @csrf
...
<textarea rows="5" class="form-control @error('open_description') is-invalid @enderror" name="open_description" id="open_description"  rows="5"></textarea>
...
<!-- ====================######################################========================== -->
 ...
 <form method="POST" action="{{route('Teamleader.destroy','delete')}}">
  {{method_field('delete')}}
  @csrf
...
<select id="teamleader_id" name="teamleader_id" class="select2bs4 form-control @error('state_id') is-invalid @enderror" style="width: 100%; height: 30;" data-vldtr="required" >
...
<div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
              <form method="POST" action="{{route('Teamleader.update',$shupdate->id)}}">
                @csrf
                 {{method_field('patch')}}
              ...
              <h4 class="modal-title" style="border-color: #007bff">Tickets Actions</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<!-- ============================================== -->                         
                                <div class="col-md-12">
                                 <label >{{ __('Descriptions') }}</label>
<textarea rows="2"  class="form-control @error('open_description') is-invalid @enderror" name="open_description" id="open_description"  rows="5">
...
<label >{{ __('Assign To') }}</label>
<select id="teamleader_id" name="teamleader_id" readonly="true"  class="select2bs4 form-control @error('state_id') is-invalid @enderror" style="width: 100%; height: 30;" data-vldtr="required" >
     @if(isset($showteamleader))
 @foreach($showteamleader as $data)
<option value="{{$data->id ?? ''}}" <?php if($data->id==$shupdate->teamleader_id){ ?> selected="true" <?php } ?> >{{$data->name ?? ''}}</option>
 @endforeach
 @endif
</select>
</div>
...
<div class="col-md-3">
          ...
          <label>Work Type</label>
            <select name="type" class="form-control" >
            <option value="1" <?php if($shupdate->type_id==1){ ?> selected="true" <?php } ?>>corrective</option>
            <option value="2" <?php if($shupdate->type_id==2){ ?> selected="true" <?php } ?>>breakdown</option>
            <option value="3" <?php if($shupdate->type_id==3){ ?> selected="true" <?php } ?>>job</option>
            <option value="4" <?php if($shupdate->type_id==4){ ?> selected="true" <?php } ?>>accident</option>
...
<div class="col-md-3">
          ...
          <label>Work Trade</label>
          <select name="trade" class="form-control" >
          <option value="1" <?php if($shupdate->trade_id==1){ ?> selected="true" <?php } ?>>mechanical</option>
          <option value="2" <?php if($shupdate->trade_id==2){ ?> selected="true" <?php } ?>>electrical</option>
          </select>
...
<div class="col-md-3">
          ...
          <label>Work Priority</label>
          <select name="priority" class="form-control" >
            <option value="1" <?php if($shupdate->priority_id==1){ ?> selected="true" <?php } ?>>normal</option>
            <option value="2" <?php if($shupdate->priority_id==2){ ?> selected="true" <?php } ?>>urgent</option>
            <option value="3" <?php if($shupdate->priority_id==3){ ?> selected="true" <?php } ?>>emergency</option>
          </select>
...
<div class="form-group row">
  ...
  <textarea rows="2"  class="form-control @error('work_description') is-invalid @enderror" name="work_description" id="open_description"  rows="5">
...
<table width="100%" align="center" border="0" style="border-collapse: collapse;">
  <tr align="center"><td width="33%"><font face="arial" size="3"> HAM Teamleader</font></th><td width="33%"></th><td align="center" width="33%"><font face="arial" size="3"> {{ $data->name ?? '' }} Representative </font></th></tr>
  <tr><td align="center" width="33%"><font face="arial" size="3"><b> {{ $data->Teamleader ?? ''  }}</b></font> </th><td align="center" width="33%"></th><td width="33%" align="center"><font face="arial" size="3"><b> {{ $data->Representative ?? ''  }}</b></font></th></tr>
...
<div class="input-group">
                                ...
                                <input id="ticketno"  data-vldtr="required" type="text" class="form-control @error('ticketno') is-invalid @enderror"
...
<input name="rows[{{$sho->id}}][items]" type="hidden" value="{{$sho->id}}"  size="4">
  <input name="rows[{{$sho->id}}][client]" type="hidden" value="{{$sho->clientid}}"  size="4">      
      ...
      <input id="Description{{$sho->id}}" data-vldtr="required" type="hidden" class="form-control @error('Description') is-invalid @enderror"
                                    name="rows[{{$sho->id}}][Description]" value="{{ $sho->service }}" >
{{ $sho->service }}
                                  </th>
