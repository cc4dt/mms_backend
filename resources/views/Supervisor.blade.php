        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <a href="{{asset(route('ticket',$show->id))}}">
                        ...
                        <div class="modal-content bg-danger">
                            <div class="modal-header">
                                <h4 class="modal-title">Delete ticket
                                    ...
                                    <form method="POST" action="{{route('Supervisor.destroy','delete')}}">
                                        {{method_field('delete')}}
                                        @csrf
                ...
                <div class="modal fade" id="modal-edit">
                    <div class="modal-dialog modal-lg">
                        <form method="POST" action="{{route('Supervisor.update',$shupdate->id)}}">
                            @csrf
                            {{method_field('patch')}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="state_id" name="state_id"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$shupdate->state_id){ ?> selected="true"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="station_id" name="station_id" value="{{ old('station_id') }}"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$shupdate->station_id){ ?> selected="true"
                                                    <?php } ?>>
                                                    {{$data->name_en ?? ''}}
                                                </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="equipment_id" name="equipment_id"
                                                ...
                                                @foreach($equipmentdata as $data)
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$shupdate->equipment_id){ ?> selected="true"
                                                    <?php } ?>>{{$data->name_en ?? ''}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="breakdown_id" name="breakdown_id"
                                                ...
                                                <option value="{{$data->id ?? ''}}"
                                                    <?php if($data->id==$shupdate->breakdown_id){ ?> selected="true"
                                                    <?php } ?>>
                                                    {{$data->name_en ?? ''}}
                                                </option>
                                                @endforeach
...
?>
                            ...
                            <table width="100%" align="center" border="0" style="border-collapse: collapse;">
                                <tr align="center">
                                    <td width="33%">
                                        <font face="arial" size="3"> HAM Supervisor</font>
                                        </th>
                                    <td width="33%">
                                        </th>
