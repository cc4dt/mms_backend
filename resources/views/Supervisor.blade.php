...
<font size="2">
  <table id="example2" class="table table-bordered table-striped">
     ...
     @if($show->status_id==1)    
 <a href="{{asset(route('Supervisor.edit',$show->id))}}"> <li class="fa fa-edit" ></li>
                           </a>
                           @endif
      
       {{" - "}}

                            <a href="{{asset(route('Supervisor.show',$show->id))}}"> <li class="fa fa-eye" data-backdrop="static"
...
<div class="form-group row">
  ...
  <textarea rows="2"  class="form-control @error('work_description') is-invalid @enderror" name="work_description" id="work_description"  rows="5">
