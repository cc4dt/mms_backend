                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="direct-chat-img" img src="{{ asset('RTL/dist/img/user1-128x128.jpg')}}" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="direct-chat-img" img src="{{ asset('RTL/dist/img/user3-128x128.jpg')}}" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          بهتره اینو باور کنی :)
                        </div>
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user1-128x128.jpg')}}">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user7-128x128.jpg')}}">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user3-128x128.jpg')}}">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user5-128x128.jpg')}}">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user6-128x128.jpg')}}">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" img src="{{ asset('RTL/dist/img/user8-128x128.jpg')}}">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="RTL/pages/examples/invoice.html">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="RTL/pages/examples/invoice.html">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="RTL/pages/examples/invoice.html">OR7429</a></td>
                      <td>آیفون X max</td>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="{{ asset('RTL/dist/img/default-150x150.png')}}" alt="Product Image" class="img-size-50">
                    </div>
