                            ...
                            <center>
                                <div class="image">
                                    <img src="{{ asset('dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2"
                                        width="110" height="100" alt="User Image">
                                </div>
                            ...
                            <table border="0" width="100%" align="center">
                                ...
                                <tr>
                                    <td align="center" width="60%"> <a href="#" class="dropdown-item dropdown-footer"
                                            ...
                                            <image src="{{ asset('dist/img/change.png')}}" width="20" height="20"> Chane
                                                My Password
                                        </a> </td>
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-danger navbar-badge">
                            ...
                            {{ \App\Ticket::where(['teamleader_id' => Auth::user()->id])->get()->count() }} @endif
                            @if(Auth::user()->level_id==4)
                            {{ \App\Ticket::where(['created_by_id' => Auth::user()->id])->get()->count() }} @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        @for($i=1;$i<=9;$i++) <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                ...
                " class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="@if(Auth::user()->level_id==2) {{ route('breakdown-report') }} @endif"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="@if(Auth::user()->level_id==2) {{ route('maintenance-report') }} @endif"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
