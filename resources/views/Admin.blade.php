...
<font size="2">
  <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>{{ $show->name ?? '' }}</th>
                        <th>{{ $show->email ?? '' }}</th>
                        <th>{{ \App\User::LEVELS[$show->level_id] }}</th>
 ...
 <a href="{{asset(route('Admin.edit',$show->id))}}"> <li class="fa fa-edit" ></li>
                           </a>
                         
       {{" - "}}

                            <a href="{{asset(route('Admin.show',$show->id))}}"> <li class="fa fa-eye" data-backdrop="static"
...
<div class="form-group">
                            <label >{{ __('Name') }}</label>
                            <input id="name" data-vldtr="required" type="text" class="form-control @error('name') is-invalid @enderror"
    ...
    <input id="email" data-vldtr="required,email" type="email" class="form-control @error('email') is-invalid @enderror"
                      ...
                      <div class="form-group">
                            <label >{{ __('Password') }}</label>
                                ...
                                <input id="password" type="password"
                                    class="form-control @error('password') is-invalid @enderror" data-vldtr="required" name="password"
                            ...
                            <label >{{ __('Confirm Password') }}</label>
                                  ...
                                  <input id="password-confirm" data-vldtr-matches="password" type="password" class="form-control"
 ...
 <div class="form-group">
                            ...
                            <label >{{ __('User Type') }}</label>
                                 ...
                                 <option value="3">Teamleaders</option>
                                 <option value="4">Dealers</option>
                                 <option value="1">System Admins</option>
...
<!-- ====================######################################========================== -->
 ...
 <form method="POST" action="{{route('Admin.destroy','delete')}}">
  {{method_field('delete')}}
  @csrf
 ...
 <form method="POST" action="{{route('Admin.create','head')}}">
  {{method_field('head')}}
  @csrf
                  <input id="id" type="hidden" name="id" value="">
...
<div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
              <form method="POST" action="{{route('Admin.update',$shupdate->id)}}">
                @csrf
                 {{method_field('patch')}}
              ...
              <h4 class="modal-title" style="border-color: #007bff">Edit Users</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<div class="form-group">
    ...
    <input   type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{$shupdate->email}}" > 
</div>
 ...
 <div class="form-group">
                            ...
                            <label >{{ __('User Type') }}</label>
                                 ...
                                 <option value="5" <?php if($shupdate->level_id==5){ ?> selected="true" <?php } ?> >Clients</option>
                                 <option value="2" <?php if($shupdate->level_id==2){ ?> selected="true" <?php } ?> >Supervisors</option>
                                 <option value="3" <?php if($shupdate->level_id==3){ ?> selected="true" <?php } ?> >Teamleaders</option>
                                 <option value="4" <?php if($shupdate->level_id==4){ ?> selected="true" <?php } ?> >Dealers</option>
                                 <option value="1" <?php if($shupdate->level_id==1){ ?> selected="true" <?php } ?> >System Admins</option>
