    ...
    <div class="p-4 sm:p-8 md:p-12 space-y-4 space-x-4 w-100">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
        ...
        >
          ...
          <BarChart :chartData="colserAfter4pmData" :options="stationOptions" />
        </div>
        ...
        >
          ...
          <BarChart :chartData="creatorData" :options="stationOptions" />
        </div>
        ...
        >
          ...
          <BarChart :chartData="colserData" :options="stationOptions" />
        </div>
        ...
        datasets: [
          {
            ...
            backgroundColor: this.stationBreakdownCounts
              .filter((i) => i.data)
              .map((item) => this.stringToColour(item.key)),
          },
        ],
      },
      breakdownData: {
