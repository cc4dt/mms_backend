    ...
    <div class="p-4 sm:p-8 md:p-12 space-y-4 space-x-4 w-100">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
        ...
        >
          ...
          >
            <h2>Oustanding</h2>
            <div>{{ openedToMonth.length }}</div>
          </div>
          <div class="px-2 py-4 space-y-2 overflow-x-hidden overflow-y-auto" style="max-height: 250px">
            <div v-for="t in openedToMonth" :key="t.id">
              <inertia-link :href="route('ticket.show', t.id)">
                <div class="bg-gray-200 dark:bg-gray-900 rounded-md px-2 py-2">
                  <div class="flex justify-between">
                    <div>{{ t.station.name }}</div>
        ...
        >
          ...
          <BarChart
            :style="
              `height: ` + (creatorAfter4pmData.labels.length + 1) * 24 + `px`
            "
            :chartData="creatorAfter4pmData"
        ...
        >
          ...
          <BarChart
            :style="
              `height: ` + (colserAfter4pmData.labels.length + 1) * 24 + `px`
            "
            :chartData="colserAfter4pmData"
            :options="stationOptions"
          />
        </div>
        ...
        >
          ...
          <BarChart
            :style="`height: ` + (creatorData.labels.length + 1) * 24 + `px`"
        ...
        >
          ...
          <BarChart
            :style="`height: ` + (colserData.labels.length + 1) * 24 + `px`"
        ...
        >
          ...
          <BarChart
            :style="`height: ` + (stationData.labels.length + 1) * 24 + `px`"
        ...
        >
          ...
          <BarChart
            :style="`height: ` + (breakdownData.labels.length + 1) * 24 + `px`"
