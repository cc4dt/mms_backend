                  ...
                  <ul class="cursor-pointer my-3 space-y-2">
                    ...
                    >
                      ...
                      >
                        <details>
                          <summary
                            v-text="process?.equipment?.name ?? 'New'"
                          ></summary>
                          <p
                            v-if="process?.master_equipment?.serial"
                            v-text="process?.master_equipment?.serial"
                          ></p>
                        </details>
                        <button
                  ...
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <select
                        ...
                        required
                      >
                        <option v-for="item in equipment" :key="item" :value="item">
                          {{ item.name }}
                        </option>
                      </select>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                      <div v-if="equipmentFiltered.length > 0">
                        <label
                          for="master_equipment "
                          class="block text-sm font-medium text-gray-700"
                          >Serial</label
                        >
                        <select
                          id="master_equipment"
                          name="master_equipment"
                          v-model="currentProcess.master_equipment"
                          class="
                            mt-1
                            block
                            w-full
                    ...
                    <div class="col-span-6 mt-6 grid grid-cols-6 gap-6">
                      <fieldset
                        ...
                        v-for="procedure in currentProcess?.equipment?.pm_procedures ??
                        {}"
                        :key="procedure.id"
                      >
                        <div
...
export default defineComponent({
    ...
    equipmentFiltered: function () {
      return (
        this.form.station?.equipment.filter(
          (i) => i.equipment_id == this.currentProcess.equipment?.id
        ) ?? []
      );
    },
  ...
  methods: {
    ...
    // initProcedure(equipment) {
    //   var procedures = {};
    //   equipment?.pm_procedures.forEach((element) => {
    ...
    equipmentChanged() {
      ...
      this.currentProcess?.equipment?.pm_procedures?.forEach((element) => {
